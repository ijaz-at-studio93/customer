import 'package:salon_customer/model/cart/salon_service_add_cart_model.dart';
import 'package:salon_customer/util/logger.dart';

class SalonServiceAddCartModel {
  int? statusCode;
  bool? success;
  Data? data;
  String? message;
...
class Data {
  ...
  List<SalonServicesWithProduct>? salonServicesWithProduct;
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json['salonServicesWithProduct'] != null) {
      salonServicesWithProduct = <SalonServicesWithProduct>[];
      json['salonServicesWithProduct'].forEach((v) {
        salonServicesWithProduct!.add(SalonServicesWithProduct.fromJson(v));
      });
    }
  }
...
class SalonServicesWithProduct {
  int? price;
  int? quantity;
  double? rating;
  String? id;
