  ...
  ArtiestData.fromJson(Map<String, dynamic> json) {
    ...
    if (json['categorizedServiceList'] != null) {
      ...
      json['categorizedServiceList'].forEach((v) {
        categorizedServiceList!.add(CategorizedServiceList.fromJson(v));
      });
    }
  }
...
/*id: "7df5aba5-2cd5-4afb-81a1-0d4ecf794f72",
"public/uploads/salon/artist/portfolio/s9q8ebhik1m6edlihg.jpeg"
video: "",
bookingOrderId: "fc8b66b6-c57d-4afc-a8d5-72161be4620f",
isVideo: false*/
class Portfolio {
  String? id;
  String? image;
...
class CategorizedServiceList {
  ...
  CategorizedServiceList.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    name = json['name'];
    serviceableGender = json['serviceableGender'];
    if (json['services'] != null) {
