...
class ServiceRatingListTile extends StatefulWidget {
  final String appointmentId;
  final Services servicesModel;
  const ServiceRatingListTile(
      {super.key, required this.servicesModel, required this.appointmentId});

  @override
  State<ServiceRatingListTile> createState() => _ServiceRatingListTileState();
}

class _ServiceRatingListTileState extends State<ServiceRatingListTile> {
      ...
      child: Column(
        ...
        children: [
          ...
          Container(
              ...
              child: TextField(
                readOnly:  widget.servicesModel.isReviewGiven ??  false ? true  :  false,
                canRequestFocus:  widget.servicesModel.isReviewGiven ??  false ? false  :  true,
