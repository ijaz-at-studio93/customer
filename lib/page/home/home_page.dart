  ...
  class _HomePageState extends State<HomePage>
    ...
    void initState() {
      super.initState();
      print("🧠 CHECK DIALOG");
      print("hasVisitedSalon: ${SharedPrefs.readBoolValue(PrefConstants.hasVisitedSalon)}");
      print("hasShownSalonDialog: ${SharedPrefs.readBoolValue(PrefConstants.hasShownSalonDialog)}");
                                  ...
                                  onPress: () async {
                                    ...
                                    if (changed == true) {
                                      _homeController.doGetHomeSalonList(
                                        ...
                                        homeService: atHome,
                                        offset: 1,
                                        size: 500, // 👈 unchanged as you requested
                                        lat: double.parse(
                                          SharedPrefs.readStringValue(
