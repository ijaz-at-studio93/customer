                                  ...
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: AppTextTheme.medium.copyWith(
                                        ...
                                        fontWeight: FontWeight.w500,   // ✅ Medium (best for tabs/buttons)
            ...
            child: Column(
              ...
              children: [
                ...
                Container(
                  width: 261,
                  height: 132,
                  padding: const EdgeInsets.only(left: 16, right: 16, bottom: 5, top: 30),
                  decoration: BoxDecoration(
                    color: Colors.white,
                    borderRadius: BorderRadius.circular(20),
                  ...
                  child: Center(
                    child: Text(
                      (_authController.userResponseModel.data?.userData?.name ?? "")
                          .isNotEmpty
                          ? _authController.userResponseModel.data!.userData!.name![0]
                          .toUpperCase()
                          : "",
                      textAlign: TextAlign.center,
                      style: const TextStyle(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(
              height: 118,
              child: Obx(() {
                final current = _homeController.homeCategoryListResponseModel.data ?? [];
                final selected = _homeController.getLastMakeYourOwnPackageModel.data ?? [];
                                ...
                                decoration: ShapeDecoration(
                                  gradient: RadialGradient(
                                    ...
                                    colors: selectedGender.value == 1
                                        ? [const Color(0xFFFFCAF9), Colors.white]
                                        : [const Color(0xFFE1D5FF), Colors.white],
                                  ),
                                  shape: RoundedRectangleBorder(
                    ...
                    Expanded(
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            print(item.name);
                            print("${APIConstants.image}${item.imageMale}");
                            return GestureDetector(
                              onTap: () {
                                List<String> storeServiceId = [];
                                var id = item.id;
                                  ...
                                  ClipRRect(
                                    ...
                                    child: CachedNetworkImage(
                                      ...
                                      errorWidget: (context, url, error) {
                                        print("🔍 FULL ITEM: ${item.toJson()}");
                                        print("name is: ${item.name}");
                                        print("👉 FINAL URL USED: ${selectedGender.value == 0 ? item.imageMale : item.imageFemale}");
                                        print("❌ ERROR: $url");
                                      ...
                                      imageBuilder: (context, imageProvider) {
                                        print("✅ SUCCESS: ${selectedGender.value == 0 ? item.imageMale : item.imageFemale}");
                                        return Container(
                                          height: 60,
                                          width: 60,
                                          decoration: BoxDecoration(
                                    ...
                                    child: Row(
                                      children: [
                                        ...
                                        Text(
                                          ...
                                          style: const TextStyle(
                                            fontFamily: "Outfit",
                                            fontWeight: FontWeight.w700, // Bold (Figma)
                                            fontSize: 52,                // Exact Figma size
                                            letterSpacing: -4,           // Tight spacing like design
                                            height: 1.0,                 // Prevent vertical overflow
                          ...
                          InkWell(
                            onTap: () {
                              setState(() {
                                ...
                                //               PrefConstants.longitude)));
                                // }
                                isHighDiscountSelected = !isHighDiscountSelected;
                              });
                              applyFilters();
                            },
                            child: Container(
